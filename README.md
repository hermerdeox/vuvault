...
- Two explicit auth modes:
  - **production**: WebAuthn PRF passkey-bound vault key. Cannot be unlocked without the original platform authenticator.
...
- Cannot be unlocked without the original platform authenticator.
